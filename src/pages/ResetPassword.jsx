...
export default function ResetPassword() {
  ...
  // NB: Supabase place son token de récupération dans le hash de l'URL
  // (#access_token=...&type=recovery), pas dans ?token=. On tente donc la
  // réinitialisation même sans "token" en query — Supabase aura déjà
  // restauré la session recovery depuis le hash au chargement de la page.
  return (
